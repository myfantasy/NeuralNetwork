...
namespace MyFantasy.NeuralNetwork.Common
{
    public partial class NeuralnetField
    {
        ...
        public static Dictionary<string, Action<Field, Field, int[], Dictionary<long, double>>> known_SetPointToField_funcs = new Dictionary<string, Action<Field, Field, int[], Dictionary<long, double>>>()
        {
            ...
            { "GetPointFromField_Point_16x16", SetToField_Point_x(16, 16) },
            { "GetPointFromField_Point_20x20", SetToField_Point_x(20, 20) },
            { "GetPointFromField_Point_40x40", SetToField_Point_x(40, 40) },
            { "GetPointFromField_Point_half_5x5", SetToField_Point_x_half(5, 5) },
            { "GetPointFromField_Point_half_8x8", SetToField_Point_x_half(8, 8) },
            { "GetPointFromField_Point_half_10x10", SetToField_Point_x_half(10, 10) },
            { "GetPointFromField_Point_half_16x16", SetToField_Point_x_half(16, 16) },
            { "GetPointFromField_Point_half_20x20", SetToField_Point_x_half(20, 20) },
            { "GetPointFromField_Point_half_40x40", SetToField_Point_x_half(40, 40) },
        };
        ...
        public static Dictionary<string, Func<Field, int[], Dictionary<long, double>>> known_GetResultFromField_funcs = new Dictionary<string, Func<Field, int[], Dictionary<long, double>>>()
        {
            { "SetResultToField_Point", GetResultFromField_Point },
            { "SetResultToField_Point_1x1", GetResultFromField_Point_x(1, 1) },
            { "SetResultToField_Point_2x2", GetResultFromField_Point_x(2, 2) },
            { "SetResultToField_Point_3x3", GetResultFromField_Point_x(3, 3) },
            { "SetResultToField_Point_4x4", GetResultFromField_Point_x(4, 4) },
            { "SetResultToField_Point_5x5", GetResultFromField_Point_x(5, 5) },
            { "SetResultToField_Point_8x8", GetResultFromField_Point_x(8, 8) },
        };
        ...
        public static Action<Field, Field, int[], Dictionary<long, double>> SetToField_Point_x(int x, int y)
        {
            return (f, m, p, d) =>
            {
                int k = 0;
        ...
        public static Action<Field, Field, int[], Dictionary<long, double>> SetToField_Point_x_half(int x, int y)
        {
            return (f, m, p, d) =>
            {
                int k = 0;
        ...
        public static Dictionary<long, double> GetResultFromField_Point(Field f, int[] p)
        {
            return new Dictionary<long, double>() { { 0, f[p] } };
        }
        ...
        public static Func<Field, int[], Dictionary<long, double>> GetResultFromField_Point_x(int x, int y)
        {
            return (f, p) =>
            {
                var res = new Dictionary<long, double>();
                ...
                for (int i = 0; i < x; i++)
                {
                    for (int j = 0; j < y; j++)
                    {
                        res.AddOrUpdate(k, f[p0.CloneArr().AddVal(0, i).AddVal(1, j)]);
